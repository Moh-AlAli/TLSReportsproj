...
Public Class R12goodspallet
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "CATS.ReportsProj.R12goodspallet.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedR12goodspallet
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As R12goodspallet = New R12goodspallet()
        rpt.Site = Me.Site
        Return rpt
    End Function
