...
Public Class R2cdemptycont
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "CATS.ReportsProj.R2cdemptycont.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedR2cdemptycont
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As R2cdemptycont = New R2cdemptycont()
        rpt.Site = Me.Site
        Return rpt
    End Function
