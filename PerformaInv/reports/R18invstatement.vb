...
Public Class R18invstatement
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "CATS.ReportsProj.R18invstatement.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedR18invstatement
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As R18invstatement = New R18invstatement()
        rpt.Site = Me.Site
        Return rpt
    End Function
