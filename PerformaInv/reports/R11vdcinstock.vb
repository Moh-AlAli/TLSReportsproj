...
Public Class R11vdcinstock
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "CATS.ReportsProj.R11vdcinstock.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_bl() As CrystalDecisions.[Shared].IParameterField
        Get
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_at9() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedR11vdcinstock
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As R11vdcinstock = New R11vdcinstock()
        rpt.Site = Me.Site
        Return rpt
    End Function
