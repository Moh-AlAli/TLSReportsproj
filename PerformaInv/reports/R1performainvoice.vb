...
Public Class R1performainvoice
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "CATS.ReportsProj.R1performainvoice.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedR1performainvoice
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As R1performainvoice = New R1performainvoice()
        rpt.Site = Me.Site
        Return rpt
    End Function
