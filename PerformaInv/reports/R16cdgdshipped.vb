...
Public Class R16cdgdshipped
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "CATS.ReportsProj.R16cdgdshipped.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedR16cdgdshipped
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As R16cdgdshipped = New R16cdgdshipped()
        rpt.Site = Me.Site
        Return rpt
    End Function
