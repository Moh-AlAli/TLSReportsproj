...
Public Class R8carsinstock
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "CATS.ReportsProj.R8carsinstock.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedR8carsinstock
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As R8carsinstock = New R8carsinstock()
        rpt.Site = Me.Site
        Return rpt
    End Function
