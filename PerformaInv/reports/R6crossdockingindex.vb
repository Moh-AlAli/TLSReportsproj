...
Public Class R6crossdockingindex
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "R6crossdockingindex.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "CATS.ReportsProj.R6crossdockingindex.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedR6crossdockingindex
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As R6crossdockingindex = New R6crossdockingindex()
        rpt.Site = Me.Site
        Return rpt
    End Function
