...
Public Class R9carsunstuff
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "CATS.ReportsProj.R9carsunstuff.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedR9carsunstuff
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As R9carsunstuff = New R9carsunstuff()
        rpt.Site = Me.Site
        Return rpt
    End Function
