...
Public Class R3exportcont
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "CATS.ReportsProj.R3exportcont.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedR3exportcont
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As R3exportcont = New R3exportcont()
        rpt.Site = Me.Site
        Return rpt
    End Function
