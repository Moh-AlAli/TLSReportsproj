...
Public Class R15gdpallblag
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "CATS.ReportsProj.R15gdpallblag.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedR15gdpallblag
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As R15gdpallblag = New R15gdpallblag()
        rpt.Site = Me.Site
        Return rpt
    End Function
