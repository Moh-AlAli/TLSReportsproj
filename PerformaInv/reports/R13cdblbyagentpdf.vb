...
Public Class R13cdblbyagentpdf
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "CATS.ReportsProj.R13cdblbyagentpdf.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_custdec() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedR13cdblbyagentpdf
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As R13cdblbyagentpdf = New R13cdblbyagentpdf()
        rpt.Site = Me.Site
        Return rpt
    End Function
