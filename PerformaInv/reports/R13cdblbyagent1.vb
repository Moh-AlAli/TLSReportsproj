...
Public Class R13cdblbyagent
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "CATS.ReportsProj.R13cdblbyagent.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedR13cdblbyagent
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As R13cdblbyagent = New R13cdblbyagent()
        rpt.Site = Me.Site
        Return rpt
    End Function
