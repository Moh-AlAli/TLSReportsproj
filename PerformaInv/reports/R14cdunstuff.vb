...
Public Class R14cdunstuff
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "CATS.ReportsProj.R14cdunstuff.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedR14cdunstuff
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As R14cdunstuff = New R14cdunstuff()
        rpt.Site = Me.Site
        Return rpt
    End Function
