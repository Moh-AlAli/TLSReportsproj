...
Public Class R4loadformbyCD
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "CATS.ReportsProj.R4loadformbyCD.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedR4loadformbyCD
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As R4loadformbyCD = New R4loadformbyCD()
        rpt.Site = Me.Site
        Return rpt
    End Function
