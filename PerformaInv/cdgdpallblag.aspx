<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="cdgdpallblag.aspx.vb" Inherits="CATS.ReportsProj.cdgdpallblag" %>
...
<body>
    ...
    <div>
      ...
      <td  align="center">
      <asp:Label ID="Label1" CssClass="lblt"   runat="server" Text="Daily Inventory by agent"></asp:Label>
      </td>
      <td  class="tddiv">
      </td>
      <td>
