<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="srchbl.aspx.vb" Inherits="CATS.ReportsProj.srchblaspx" %>
   ...
   <td  >
    <asp:GridView ID="gvbl" Visible ="false"  Width ="320px"   runat="server" AutoGenerateColumns="False" 
        ...
        <asp:TemplateField HeaderText="ID" Visible="false"  > 
           <ItemTemplate >
               <asp:LinkButton ID="Lkid" Text ='<%#Bind("cidt_Carsindexdetailid")%>' runat="server" ></asp:LinkButton>
           </ItemTemplate> 
            </asp:TemplateField>
           <asp:TemplateField HeaderText="B\L">
           <ItemTemplate >
               <asp:LinkButton ID="Lkbl" 
                   Text ='<%#bind("cidt_BL")%>' runat="server" onclick="lkblclick"></asp:LinkButton>
           </ItemTemplate> 
            </asp:TemplateField>
        </Columns>
