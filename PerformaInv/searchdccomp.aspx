<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="searchdccomp.aspx.vb" Inherits="CATS.ReportsProj.searchdccomp" %>
...
<body>
  ...
  <asp:Button ID="Bcls" runat ="server" Text="Close" />
   ...
   <tr>
   <td >
      <asp:GridView ID="gvcompsear" Visible ="false"  Width ="320px"   runat="server" AutoGenerateColumns="False" 
