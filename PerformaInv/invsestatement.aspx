<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="invsestatement.aspx.vb" Inherits="CATS.ReportsProj.invsestatement" %>
...
<body>
    ...
    <table class="fultab" >
      ...
      <td>
       <asp:Label ID="Label1" CssClass="lblt"   runat="server" Text="Invoices Statement"></asp:Label>
      </td>
      </tr>
      </table>
 ...
 <td class="td" >
    ...
    <asp:Label ID="Label2"  CssClass ="lbl" runat="server" Text="Type"></asp:Label>
    </td>
    <td class="auto-style2">
        <asp:DropDownList ID="DDLtype" Width="340px" runat="server"></asp:DropDownList>
