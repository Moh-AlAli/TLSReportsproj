<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="cdunstuffed.aspx.vb" Inherits="CATS.ReportsProj.cdunstuffed" %>
...
<body>
    ...
    <table class="fultab" >
      ...
      <td>
       <asp:Label ID="Label1" CssClass="lblt"   runat="server" Text="Daily INBound Report"></asp:Label>
      </td>
      </tr>
      </table>
    ...
    <tr>
    <td  >
    <asp:Panel ID="panpar"  runat  ="server"  Height ="260px" Width="625px"  >
   <table >
