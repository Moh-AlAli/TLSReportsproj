...
<body>
    ...
    <div>
      ...
      <td  align="center">
      <asp:Label ID="Label1" CssClass="lblt"   runat="server" Text="CARS In-stock"></asp:Label>
      </td>
      <td  class="tddiv">
      </td>
      <td>
    ...
    <td class="rttab" >
    <asp:Panel ID="panpar"  runat  ="server"  Height ="280px"  >
   <table >
   <tr>
   <td>
    <table   >
 ...
 <tr>
     ...
     <asp:label ID="lbldttyp"  CssClass ="lbl"  runat="server"  Text ="Date Type"></asp:label> 
         ...
         <td><asp:DropDownList ID="DDLDatetype" Width="360px" runat="server" >
             ...
             <asp:ListItem>Un-stuffingDate</asp:ListItem>
