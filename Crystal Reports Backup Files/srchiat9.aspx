<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="srchiat9.aspx.vb" Inherits="CATS.ReportsProj.srchiat9" %>
...
<body>
   ...
   <td >
   <asp:Label ID="Label2" CssClass ="lblt" runat="server" Text="Search AT9"></asp:Label>
   </td>
   </tr>
   </table>
   </td>
  ...
  <asp:Button ID="Bcls" runat ="server" Text="Close" />
   ...
   <tr>
   <td >
      <asp:GridView ID="gvat" runat="server" AutoGenerateColumns="False" 
           CellPadding="4" ForeColor="#333333" GridLines="None" Visible="false" 
           Width ="320px">
           <RowStyle BackColor="#F7F6F3" ForeColor="#333333" />
           <Columns>
           <asp:TemplateField HeaderText="AT9" Visible="false">
                   <ItemTemplate>
                       <asp:LinkButton ID="Lkid" runat="server" Text='<%#Bind("caid_CarsIndexID")%>'></asp:LinkButton>
                   </ItemTemplate>
               </asp:TemplateField>
               <asp:TemplateField HeaderText="AT9">
                   <ItemTemplate>
                       <asp:LinkButton ID="Lkat" runat="server" onclick="lkatclick" 
                           Text='<%#bind("caid_AT9")%>'></asp:LinkButton>
                   </ItemTemplate>
               </asp:TemplateField>
           </Columns>
