<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="dcinstock.aspx.vb" Inherits="CATS.ReportsProj.dcinstock" %>
...
<body>
    ...
    <div>
      ...
      <td  align="center">
      <asp:Label ID="Label1" CssClass="lblt"   runat="server" Text="DC In-stock"></asp:Label>
      </td>
      <td  class="tddiv">
      </td>
      <td>
