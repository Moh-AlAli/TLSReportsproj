<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="searchdiat.aspx.vb" Inherits="CATS.ReportsProj.searchdiat" %>
...
<body>
   ...
   <tr>
   <td>
   <asp:Button ID="Bsat" runat="server" Text="Search" style="height: 26px" />
   </td>
  <td>
           ...
           <Columns>
            <asp:TemplateField HeaderText="ID" Visible ="false" >
               ...
               <asp:TemplateField HeaderText="AT9">
                   <ItemTemplate>
                       <asp:LinkButton ID="Lkat" runat="server" onclick="lkatclick" Text='<%#bind("cdin_AT9")%>'></asp:LinkButton>
                   </ItemTemplate>
               </asp:TemplateField>
           </Columns>
