<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="srchunat9.aspx.vb" Inherits="CATS.ReportsProj.srchunat9" %>
           ...
           <Columns>
            <asp:TemplateField HeaderText="AT9" Visible="false">
               ...
               <asp:TemplateField HeaderText="AT9">
                   <ItemTemplate>
                       <asp:LinkButton ID="Lkat" runat="server" onclick="lkatclick" Text='<%#Bind("caid_AT9")%>'></asp:LinkButton>
                   </ItemTemplate>
               </asp:TemplateField>
           </Columns>
